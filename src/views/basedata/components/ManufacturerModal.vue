...
import type { Manufacturer, ManufacturerForm } from '@/api/interface/basedata'
  ...
  >
    <el-form ref="formRef" :model="formData" :rules="rules" label-width="90px" @submit.prevent="handleSubmit">
      <el-form-item label="厂商名称" prop="name">
        <el-input ref="nameInputRef" v-model="formData.name" placeholder="请输入厂商名称" :maxlength="100" />
      </el-form-item>
