...
**最后更新**：2026-09-02（**生产运营阶段**：M10 全链路上线生产（0.1.3 = ba1ac99，含退还对接/终态同步修复/抄送通知）；钉钉连接器切换至生产公司森科五金，生产数据导入完成（仓位/审批链/资产台账/用户开通）；日常台账增量以 SQL 直写维护（最新：张侃/汤昌茂建号 + 4 编码台账更新）。后端 main = 649e2e7，前端 main = ef8bb44，两仓库工作区干净、均已推送）
**当前阶段负责人**：待指派
